...
select salary from EmployeePayroll where name='Abhi'
...
Update EmployeePayroll set EmployeePhone='1234567891',Department='IT' where name='Abhi'
...
Update EmployeePayroll set Basic_pay=null  where name in ('Abhi','Swayam','Arya')
Alter table EmployeePayroll add 
Deduction money,
Taxable_Pay money,
Income_Tax money,
...
insert into  EmployeePayroll values('Abhi',20000,'2023-01-12','F','1234567891','India',null,'EXTC',10000,0,0,null)
...
(1,'Abhi sahu',964325436,'5298 Wild Indigo, Georgia,340002','2018-03-28','F'),
